...
{*            {if $attribute.class_content.default_selection_node}
    ...
    <select id="eccael_target_{$attribute.contentclass_attribute.id}" name="ContentClass_ngenhancedlink_target_internal_{$attribute.contentclass_attribute.id}">
        ...
        <option value="1" {if not($attribute.contentclass_attribute.content.allowedTargetsInternal|contains('link_new_tab'))}disabled="disabled"{/if} {if eq($content_data.type, 'internal')} {eq( $content_data.target, 'link_new_tab' )|choose( '', 'selected="selected"' )}{/if}>{'Link in new tab'|i18n( 'design/standard/class/datatype' )}</option>
...
<div class="block external-link-block-{$attribute.id}">
    ...
    <select id="eccael_target_type_{$attribute.contentclass_attribute.id}" name="ContentClass_ngenhancedlink_target_external_{$attribute.contentclass_attribute.id}">
        ...
        <option value="1" {if not($attribute.contentclass_attribute.content.allowedTargetsExternal|contains('link_new_tab'))}disabled="disabled"{/if} {if eq($content_data.type, 'external')} {eq( $content_data.target, 'link_new_tab' )|choose( '', 'selected="selected"' )}{/if}>{'Link in new tab'|i18n( 'design/standard/class/datatype' )}</option>
